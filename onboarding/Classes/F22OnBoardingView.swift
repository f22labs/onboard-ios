...
public protocol F22onBoardingViewProtocol:class {
    func pushNextScreen()
}

public class F22onBoardingView: UIView,UIScrollViewDelegate {
    ...
    weak var delegate:F22onBoardingViewProtocol?
    ...
    @available(iOS 8.2, *)
    public convenience init(inputViews:[Dictionary<String,String>]) {
        self.init()
    ...
    private func createViews() {
        ...
        self.pageControl?.pageIndicatorTintColor = UIColor.F22rgba(fromHex: 0x15B4F1, alpha: 0.2)
        self.pageControl?.currentPageIndicatorTintColor = UIColor.F22rgb(fromHex: 0x15B4F1)
        self.addSubview(self.pageControl!)
        
        self.nextButton = UIButton()
        self.nextButton?.setTitle("NEXT", for: .normal)
        self.nextButton?.setTitleColor(.white, for: .normal)
        self.nextButton?.backgroundColor = UIColor.F22rgb(fromHex: 0x15B4F1)
        ...
        for dictionary in self.dataSource! {
            ...
            titleLabel.textColor = UIColor.F22rgb(fromHex: 0x424242)
            ...
            subTitle.textColor = UIColor.F22rgba(fromHex: 0x424242, alpha: 0.55)
